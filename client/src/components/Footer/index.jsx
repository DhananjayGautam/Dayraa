      ...
      <footer className="py-6 bg-[#fafafa]">
        <div className="container">
          ...
          <div className="footer flex px-3 lg:px-0 flex-col lg:flex-row py-8">
            <div className="part1 w-full lg:w-[30%] border-r border-[rgba(0,0,0,0.1)]">
            ...
            <div className="part2  w-full lg:w-[30%] flex pl-0 lg:pl-8 mt-5 lg:mt-0">
